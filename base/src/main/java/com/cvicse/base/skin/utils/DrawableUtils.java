...
public class DrawableUtils {
    ...
    private static ColorDrawable pressed = new ColorDrawable(0xff2e2e2e);

    public static void resetPressedDrawable(View mView){
        if(mView.getBackground() == null){
            StateListDrawable stateListDrawable = new StateListDrawable();
            stateListDrawable.addState(new int[] {android.R.attr.state_pressed},pressed);
            stateListDrawable.addState(new int[] {},transparent);
            ...
            StateListDrawable stateListDrawable = new StateListDrawable();
            stateListDrawable.addState(new int[] {android.R.attr.state_pressed},pressed);
            stateListDrawable.addState(new int[] {},mView.getBackground());
            if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN){
                mView.setBackground(stateListDrawable);
            } else {
                mView.setBackgroundDrawable(stateListDrawable);
