...
public final class ActivityUtils {
    ...
    public static boolean isActivityExists(@NonNull final String packageName,
        ...
        return !(UtilsConfig.getInitContext().getPackageManager().resolveActivity(intent, 0) == null ||
                intent.resolveActivity(UtilsConfig.getInitContext().getPackageManager()) == null ||
                UtilsConfig.getInitContext().getPackageManager().queryIntentActivities(intent, 0).size() == 0);
    }
    ...
    public static List<Activity> getActivityList() {
        return UtilsConfig.sActivityList;
    }
    ...
    public static String getLauncherActivity() {
        return getLauncherActivity(UtilsConfig.getInitContext().getPackageName());
    }
    ...
    public static String getLauncherActivity(@NonNull final String packageName) {
        ...
        PackageManager pm = UtilsConfig.getInitContext().getPackageManager();
    ...
    public static Activity getTopActivity() {
        if (UtilsConfig.sTopActivityWeakRef != null) {
            Activity activity = UtilsConfig.sTopActivityWeakRef.get();
            if (activity != null) {
                return activity;
            }
        }
        List<Activity> activities = UtilsConfig.sActivityList;
    ...
    public static void finishAllActivities(final boolean isLoadAnim) {
        List<Activity> activityList = UtilsConfig.sActivityList;
    ...
    public static Drawable getActivityIcon(final Class<?> clz) {
        return getActivityIcon(new ComponentName(UtilsConfig.getInitContext(), clz));
    }
    ...
    public static Drawable getActivityLogo(final Class<?> clz) {
        return getActivityLogo(new ComponentName(UtilsConfig.getInitContext(), clz));
    }
    ...
    private static Context getActivityOrApp() {
        ...
        return topActivity == null ? UtilsConfig.getInitContext() : topActivity;
    }
