...
public final class LogUtils {
    ...
    private static void printDeviceInfo(final String filePath) {
        ...
        int versionCode = 0;
        try {
            PackageInfo pi = UtilsConfig.getInitContext()
                    .getPackageManager()
                    .getPackageInfo(UtilsConfig.getInitContext().getPackageName(), 0);
            if (pi != null) {
    ...
    public static class Config {
        private Config() {
            ...
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                    && UtilsConfig.getInitContext().getExternalCacheDir() != null)
                sDefaultDir = UtilsConfig.getInitContext().getExternalCacheDir() + FILE_SEP + "log" + FILE_SEP;
            else {
                sDefaultDir = UtilsConfig.getInitContext().getCacheDir() + FILE_SEP + "log" + FILE_SEP;
            }
        }
