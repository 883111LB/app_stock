...
public class NetworkUtils {
    ...
    public static final int NETWORK_NO      = 0;   // no network
    ...
    private static NetworkInfo getActiveNetworkInfo() {
        ConnectivityManager cm = (ConnectivityManager) UtilsConfig.getInitContext()
    ...
    public static boolean getDataEnabled() {
        try {
            TelephonyManager tm = (TelephonyManager) UtilsConfig.getInitContext().getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public static boolean getWifiEnabled() {
        WifiManager wifiManager = (WifiManager) UtilsConfig.getInitContext().getApplicationContext().getSystemService(Context.WIFI_SERVICE);
