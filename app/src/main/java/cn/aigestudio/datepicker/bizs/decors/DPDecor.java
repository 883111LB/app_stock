...
public class DPDecor {
    /**
     * 绘制当前日期区域左上角的装饰物
     * Draw decor on Top left of current datetime area
     *
    ...
    /**
     * 绘制当前日期区域顶部的装饰物
     * Draw decor on top of current datetime area
     *
     * @param canvas 绘制图形的画布 Canvas of image drew
     * @param rect   可以绘制的区域范围 Area you can draw
     * @param paint  画笔对象 Paint
    ...
    /**
     * 绘制当前日期区域右上角的装饰物
     * Draw decor on Top right of current datetime area
     *
     * @param canvas 绘制图形的画布 Canvas of image drew
     * @param rect   可以绘制的区域范围 Area you can draw
     * @param paint  画笔对象 Paint
    ...
    /**
     * 绘制当前日期区域左边的装饰物
     * Draw decor on left of current datetime area
     *
     * @param canvas 绘制图形的画布 Canvas of image drew
     * @param rect   可以绘制的区域范围 Area you can draw
     * @param paint  画笔对象 Paint
    ...
    /**
     * 绘制当前日期区域右边的装饰物
     * Draw decor on right of current datetime area
     *
     * @param canvas 绘制图形的画布 Canvas of image drew
     * @param rect   可以绘制的区域范围 Area you can draw
     * @param paint  画笔对象 Paint
    ...
    /**
     * 绘制当前日期区域背景的装饰物
     * Draw decor of background of current datetime area
     *
     * @param canvas 绘制图形的画布 Canvas of image drew
     * @param rect   可以绘制的区域范围 Area you can draw
     * @param paint  画笔对象 Paint
