...
/**
 * 日期管理器
 * The manager of datetime picker.
 *
...
public final class DPCManager {
     ...
     * 设置有背景标识物的日期
     * <p/>
     * Set datetime which has decor of background
     *
     * @param date 日期列表 List of datetime
     */
     ...
     * 设置左上角有标识物的日期
     * <p/>
     * Set datetime which has decor on Top left
     *
     * @param date 日期列表 List of datetime
     */
     ...
     * 设置顶部有标识物的日期
     * <p/>
     * Set datetime which has decor on Top
     *
     * @param date 日期列表 List of datetime
     */
     ...
     * 设置右上角有标识物的日期
     * <p/>
     * Set datetime which has decor on Top right
     *
     * @param date 日期列表 List of datetime
     */
     ...
     * 设置左边有标识物的日期
     * <p/>
     * Set datetime which has decor on left
     *
     * @param date 日期列表 List of datetime
     */
     ...
     * 设置右上角有标识物的日期
     * <p/>
     * Set datetime which has decor on right
     *
     * @param date 日期列表 List of datetime
     */
