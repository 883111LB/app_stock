package com.cvicse.stock.markets.ui.subnewstock.adapter;
...
public class SubNewStockListAdapter extends PBaseAdapter {
    private ArrayList<SubNewStockRankingModel> modelList;

    public SubNewStockListAdapter(Context context) {
        super(context);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = mLayoutInflater.inflate(R.layout.item_list_subnewstock, parent, false);
