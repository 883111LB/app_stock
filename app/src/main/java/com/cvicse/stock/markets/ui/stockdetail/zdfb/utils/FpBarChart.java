 ...
 */
public class FpBarChart extends BarLineChartBase<BarData> implements BarDataProvider {
    ...
    public FpBarChart(Context context) {
        super(context);
    }

    public FpBarChart(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public FpBarChart(Context context, AttributeSet attrs, int defStyle) {
