 ...
 */
public class SHQQAllFragment extends PBaseFragment implements SHQQAllContract.View{
   ...
   SHQQAllContract.Presenter mPresenter;
    ...
    public static SHQQAllFragment newInstance(String stockID){
        Bundle bundle = new Bundle();
        bundle.putString(KEY_STOCK_ID,stockID);

        SHQQAllFragment shqqAllFragment = new SHQQAllFragment();
        shqqAllFragment.setArguments(bundle);
        return  shqqAllFragment;
    }
