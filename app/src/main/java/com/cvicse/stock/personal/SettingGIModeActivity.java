 ...
 */
public class SettingGIModeActivity extends PBaseActivity implements View.OnClickListener {

    @BindView(R.id.topbar)
    ToolBar mTopbar;

    @BindView(R.id.img_zce_selectfirst)
    ImageView mImgSelectfirst;
    @BindView(R.id.rel_zce_firstmode)
    RelativeLayout mRelFirstmode;

    @BindView(R.id.img_zce_sectedsecond)
    ImageView mImgSectedsecond;
    @BindView(R.id.rel_zce_secondmode)
    RelativeLayout mRelSecondmode;
    @BindView(R.id.tev_level_1)
    TextView tevLevel1;
    @BindView(R.id.tev_level_2)
    TextView tevLevel2;
