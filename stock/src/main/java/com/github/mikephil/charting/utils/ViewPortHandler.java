...
public class ViewPortHandler {
     ...
     */
    protected float mMinScaleY = 1f;

    /**
     * maximum scale value on the y-axis
     */
    protected float mMaxScaleY = Float.MAX_VALUE;

    /**
     * minimum scale value on the x-axis
     */
    protected float mMinScaleX = 1f;

    /**
     * maximum scale value on the x-axis
     */
    protected float mMaxScaleX = Float.MAX_VALUE;
    ...
    ViewPortHandlerListener  viewPortHandlerListener;

    public void setViewPortHandlerListener(ViewPortHandlerListener viewPortHandlerListener) {
        this.viewPortHandlerListener = viewPortHandlerListener;
    }
    ...
    public Matrix refresh(Matrix newMatrix, View chart, boolean invalidate) {
        ...
        if (invalidate)
            chart.invalidate();
        if(viewPortHandlerListener != null){
            viewPortHandlerListener.refresh(newMatrix,chart,invalidate);
        }
     ...
     * @return
     */
    public Matrix refreshOther(Matrix newMatrix, View chart) {
