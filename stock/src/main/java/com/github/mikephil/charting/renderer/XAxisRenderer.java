        ...
        for (int i = 0; i < positions.length; i += 2) {
            ...
            if (mViewPortHandler.isInBoundsX(x)) {
                ...
                if (mXAxis.isAvoidFirstLastClippingEnabled()) {
                    ...
                    if (i == (mXAxis.mEntryCount - 1)*2 && mXAxis.mEntryCount > 1) {
...
//        mSecondLinePaint.setTextSize(Utils.convertDpToPixel(10f));
        ...
        if (labels.length > 1) {
            ...
            Utils.drawXAxisValue(c, labels[1], x, y + labelHeight, mAxisLabelPaint, anchor, angleDegrees);
        } else {
            Utils.drawXAxisValue(c, formattedLabel, x, y, mAxisLabelPaint, anchor, angleDegrees);
        }

//        Utils.drawXAxisValue(c, formattedLabel, x, y, mAxisLabelPaint, anchor, angleDegrees);  // old
    }
