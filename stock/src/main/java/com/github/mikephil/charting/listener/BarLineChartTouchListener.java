...
public class BarLineChartTouchListener extends ChartTouchListener<BarLineChartBase<? extends BarLineScatterCandleBubbleData<?
    ...
    public MPPointF mDecelerationVelocity = MPPointF.getInstance(0,0);
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        switch (event.getAction() & MotionEvent.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (mTouchMode == DRAG && !mChart.valuesToHighlight()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (Math.abs(velocityX) > Utils.getMinimumFlingVelocity() ||
                    ...
                    if (!mChart.valuesToHighlight() && mTouchMode == DRAG && mChart.isDragDecelerationEnabled()) {
