...
public class YAxisRenderer extends AxisRenderer {
    ...
    public void renderAxisLabels(Canvas c) {
        ...
        widthHight = Utils.calcTextHeight(mAxisLabelPaint, "A");
        float yoffset = widthHight / 2.5f + mYAxis.getYOffset();
    ...
    protected void drawYLabels(Canvas c, float fixedPosition, float[] positions, float offset) {
        ...
        for (int i = 0; i < mYAxis.mEntryCount; i++) {
            ...
            if (!mYAxis.isDrawTopYLabelEntryEnabled() && i >= mYAxis.mEntryCount - 1)
                return;
            if(positions[i * 2 + 1] == mViewPortHandler.contentTop()){
                c.drawText(text, fixedPosition, mViewPortHandler.contentTop()+widthHight*1.2f, mAxisLabelPaint);
                continue;
            }
            if(positions[i * 2 + 1] == mViewPortHandler.contentBottom()){
                c.drawText(text, fixedPosition, mViewPortHandler.contentBottom() -widthHight*0.5f , mAxisLabelPaint);
                continue;
            }
