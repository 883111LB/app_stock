 ...
 *   Cost - However, refilling the pool when it is empty might incur a time cost with sufficiently bigMoneyInflow capacity.  Set the replenishPercentage to a lower number if this is a concern.
 *
...
public class ObjectPool<T extends ObjectPool.Poolable> {
     ...
     * replenished.  If the pool capacity is sufficiently bigMoneyInflow, this could come at a performance
     * cost.
     *
