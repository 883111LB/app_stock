...
/**
 * Created by liu_zlu on 2017/4/7 10:11
 */
    ...
    public static void init(){
        ...
        mLocationClient.registerLocationListener(new BDLocationListener(){
            ...
            public void onReceiveLocation(BDLocation bdLocation) {
                ...
                //location.setAddress(bdLocation.getCity());
                location.setAddress(bdLocation.getCountry()+
                        bdLocation.getProvince() + bdLocation.getCity() +bdLocation.getDistrict());
               /* NumberFormat numberFormat = NumberFormat.getInstance();
                numberFormat.setGroupingUsed(false);*/

                Log.d("BDLocation ryt",bdLocation.getCountry()+
                        bdLocation.getProvince() + bdLocation.getCity() +bdLocation.getDistrict());
                location.setLangitude(bdLocation.getLongitude());
